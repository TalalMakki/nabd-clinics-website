(function () {
  ...
  var translations = {
    ar: {
      ...
      'about.photoAlt': 'استقبال عيادات نبض التخصصية',
      ...
      'about.f2Desc': 'استشاريون وأخصائيون في عشرة تخصصات طبية مختلفة بخبرات موثوقة.',
      ...
      'dept.desc': 'عشرة أقسام طبية متخصصة يقدمها فريق طبي مؤهل لخدمتكم في مكان واحد.',
      ...
      'dept.d10Title': 'التمريض على مدار الساعة',
      'dept.d10Desc': 'طاقم تمريضي مؤهل متواجد على مدار الساعة لمتابعة رعايتكم في أي وقت.',

      'doctors.eyebrow': 'فريقنا الطبي',
      'doctors.title': 'أطباء كل تخصص',
      'doctors.desc': 'تعرّفوا على نخبة الأطباء والاستشاريين المتخصصين الذين يقدمون الرعاية في عياداتنا.',
      'doctors.d1Name': 'اللواء الدكتور أيمن الشاملي',
      'doctors.d1Spec': 'باطنة وأمراض كلى وسكر',
      'doctors.d1Cred1': 'عضو الأكاديمية الطبية العسكرية لأمراض الكلى والسكر',
      'doctors.d1Cred2': 'عضو الجمعية المصرية لأمراض الكلى',
      'doctors.d1Cred3': 'استشاري باطنة عامة وغدد صماء - جامعة عين شمس',
      'doctors.d1Cred4': 'استشاري أمراض الكلى بمستشفيات القوات المسلحة',
      'doctors.d2Name': 'د. شادي سمير غيط',
      'doctors.d2Spec': 'باطنة وجهاز هضمي ومناظير',
      'doctors.d2Cred1': 'دكتوراه الباطنة والجهاز الهضمي',
      'doctors.d2Cred2': 'مدرس الباطنة - جامعة عين شمس',
      'doctors.d2Cred3': 'استشاري الباطنة والجهاز الهضمي والكبد والسكر والمناظير',
      'doctors.d3Name': 'د. حسام عبده',
      'doctors.d3Spec': 'استشاري جراحة عامة',
      'doctors.d3Cred1': 'دكتوراه الجراحة العامة والمناظير',
      'doctors.d4Name': 'د. نضال عبيدو',
      'doctors.d4Spec': 'استشاري جراحة بدانة',
      'doctors.d5Name': 'د. مهند قنواتي',
      'doctors.d5Spec': 'استشاري عظام',
      'doctors.d5Cred1': 'استشاري جراحة عظام ومفاصل',
      'doctors.d6Name': 'د. صبحي قنواتي',
      'doctors.d6Spec': 'مخ وأعصاب',
      'doctors.d6Cred1': 'استشاري جراحة المخ والأعصاب والعمود الفقري',
      'doctors.d7Name': 'د. سحر سمان',
      'doctors.d7Spec': 'نساء وتوليد',
      'doctors.d8Name': 'د. لينا معتوق',
      'doctors.d8Spec': 'أطفال وحديثي ولادة',
      'doctors.d8Cred1': 'استشاري أطفال وحديثي ولادة',
      'doctors.d9Name': 'د. حمزة سقعان',
      'doctors.d9Spec': 'جلدية',
      'doctors.d10Name': 'د. ستيفن سمان',
      'doctors.d10Spec': 'علاج طبيعي',
      'doctors.d11Name': 'د. نور طلال',
      'doctors.d11Spec': 'علاج طبيعي',
      'doctors.d12Name': 'د. هادي دعاس',
      'doctors.d12Spec': 'علاج طبيعي',
      'doctors.d13Name': 'د. وائل عجلة',
      'doctors.d13Spec': 'تغذية علاجية',
      'doctors.d13Cred1': 'دكتور صيدلي ورياضي، متخصص في التغذية والتغذية السريرية والتغذية الرياضية، بخبرة تتجاوز 10 سنوات في التغذية واللياقة والاستشارات الغذائية',
      'doctors.d14Name': 'د. وفاء بشير',
      'doctors.d14Spec': 'روماتيزم وأمراض مناعة',
      'doctors.d14Cred1': 'بكالوريوس الطب والجراحة - جامعة جوبا',
      'doctors.d14Cred2': 'زمالة الكلية البريطانية - لندن',
      'doctors.d14Cred3': 'عضو الجمعية الأمريكية لأمراض الروماتيزم',
      'doctors.d14Cred4': 'عضو الجمعية السودانية لأمراض الروماتيزم',
      'doctors.d14Cred5': 'عضو الرابطة الأوروبية لمكافحة أمراض الروماتيزم',
      ...
      'booking.subtitle': 'عبّئوا البيانات وسيتم تحويلكم إلى واتساب لإرسال طلب الحجز.',
      'booking.name': 'اسم المريض',
      'booking.age': 'العمر',
      'booking.phone': 'رقم الهاتف',
      'booking.department': 'القسم',
      'booking.departmentPlaceholder': 'اختر القسم',
      'booking.doctor': 'الطبيب',
      'booking.doctorPlaceholder': 'اختر الطبيب',
      'booking.doctorPlaceholderLocked': 'اختر القسم أولاً',
      'booking.address': 'عنوان الزيارة المنزلية',
      'booking.addressPlaceholder': 'الحي، الشارع، رقم البناء',
      'booking.submit': 'إرسال عبر واتساب',
      'booking.close': 'إغلاق',
      'booking.deptSurgery': 'الجراحة العامة',
      'booking.deptBariatric': 'جراحة السمنة',
      'booking.deptOrtho': 'العظام',
      'booking.nursingTeam': 'فريق التمريض المختص',
      'booking.msgTitle': 'طلب حجز موعد جديد - عيادات نبض',
      'booking.msgName': 'الاسم',
      'booking.msgAge': 'العمر',
      'booking.msgPhone': 'رقم الهاتف',
      'booking.msgDept': 'القسم',
      'booking.msgDoctor': 'الطبيب',
      'booking.msgAddress': 'العنوان',
      'booking.msgLocation': 'الموقع'
    },
    en: {
      ...
      'about.photoAlt': 'Nabd Specialized Clinics reception',
      ...
      'about.f2Desc': 'Consultants and specialists across ten medical fields, with proven expertise.',
      ...
      'dept.desc': 'Ten specialized medical departments, staffed by a qualified team, all under one roof.',
      ...
      'dept.d10Title': '24/7 Nursing Care',
      'dept.d10Desc': 'A qualified nursing team available around the clock to look after your care anytime.',

      'doctors.eyebrow': 'Our Medical Team',
      'doctors.title': 'Doctors for Every Specialty',
      'doctors.desc': 'Meet the select group of specialist doctors and consultants providing care at our clinics.',
      'doctors.d1Name': 'Maj. Gen. Dr. Ayman Al-Shamali',
      'doctors.d1Spec': 'Internal Medicine, Kidney & Diabetes',
      'doctors.d1Cred1': 'Member, Military Medical Academy - Nephrology & Diabetes',
      'doctors.d1Cred2': 'Member, Egyptian Society of Nephrology',
      'doctors.d1Cred3': 'Consultant in General Internal Medicine and Endocrinology - Ain Shams University',
      'doctors.d1Cred4': 'Consultant Nephrologist, Armed Forces Hospitals',
      'doctors.d2Name': 'Dr. Shady Samir Ghait',
      'doctors.d2Spec': 'Internal Medicine, GI & Endoscopy',
      'doctors.d2Cred1': 'Doctorate in Internal Medicine and Gastroenterology',
      'doctors.d2Cred2': 'Lecturer of Internal Medicine - Ain Shams University',
      'doctors.d2Cred3': 'Consultant in Internal Medicine, Gastroenterology, Hepatology, Diabetes and Endoscopy',
      'doctors.d3Name': 'Dr. Hossam Abdo',
      'doctors.d3Spec': 'General Surgery Consultant',
      'doctors.d3Cred1': 'Doctorate in General Surgery and Endoscopy',
      'doctors.d4Name': 'Dr. Nidal Obeido',
      'doctors.d4Spec': 'Bariatric Surgery Consultant',
      'doctors.d5Name': 'Dr. Muhannad Kanawati',
      'doctors.d5Spec': 'Orthopedics Consultant',
      'doctors.d5Cred1': 'Consultant Orthopedic and Joint Surgery',
      'doctors.d6Name': 'Dr. Sobhi Kanawati',
      'doctors.d6Spec': 'Neurology & Neurosurgery',
      'doctors.d6Cred1': 'Consultant Neurosurgery, Nerve and Spine Surgery',
      'doctors.d7Name': 'Dr. Sahar Samman',
      'doctors.d7Spec': 'Obstetrics & Gynecology',
      'doctors.d8Name': 'Dr. Lina Maatouk',
      'doctors.d8Spec': 'Pediatrics & Neonatology',
      'doctors.d8Cred1': 'Consultant in Pediatrics and Neonatology',
      'doctors.d9Name': 'Dr. Hamza Saqan',
      'doctors.d9Spec': 'Dermatology',
      'doctors.d10Name': 'Dr. Stephen Samman',
      'doctors.d10Spec': 'Physical Therapy',
      'doctors.d11Name': 'Dr. Nour Talal',
      'doctors.d11Spec': 'Physical Therapy',
      'doctors.d12Name': 'Dr. Hadi Daas',
      'doctors.d12Spec': 'Physical Therapy',
      'doctors.d13Name': 'Dr. Wael Ajala',
      'doctors.d13Spec': 'Clinical Nutrition',
      'doctors.d13Cred1': 'Pharmacist and sports physician specializing in nutrition, clinical nutrition and sports nutrition, with over 10 years of experience in nutrition, fitness and nutritional counseling',
      'doctors.d14Name': 'Dr. Wafaa Bashir',
      'doctors.d14Spec': 'Rheumatology & Immunology',
      'doctors.d14Cred1': 'Bachelor of Medicine and Surgery - University of Juba',
      'doctors.d14Cred2': 'Fellowship, British College - London',
      'doctors.d14Cred3': 'Member, American College of Rheumatology',
      'doctors.d14Cred4': 'Member, Sudanese Society of Rheumatology',
      'doctors.d14Cred5': 'Member, European Alliance of Associations for Rheumatology (EULAR)',
      ...
      'booking.subtitle': "Fill in your details and you'll be redirected to WhatsApp to send your booking request.",
      'booking.name': 'Patient Name',
      'booking.age': 'Age',
      'booking.phone': 'Phone Number',
      'booking.department': 'Department',
      'booking.departmentPlaceholder': 'Select department',
      'booking.doctor': 'Doctor',
      'booking.doctorPlaceholder': 'Select doctor',
      'booking.doctorPlaceholderLocked': 'Choose a department first',
      'booking.address': 'Home Visit Address',
      'booking.addressPlaceholder': 'Neighborhood, street, building number',
      'booking.submit': 'Send via WhatsApp',
      'booking.close': 'Close',
      'booking.deptSurgery': 'General Surgery',
      'booking.deptBariatric': 'Bariatric Surgery',
      'booking.deptOrtho': 'Orthopedics',
      'booking.nursingTeam': 'Specialized Nursing Team',
      'booking.msgTitle': 'New appointment request - Nabd Clinics',
      'booking.msgName': 'Name',
      'booking.msgAge': 'Age',
      'booking.msgPhone': 'Phone',
      'booking.msgDept': 'Department',
      'booking.msgDoctor': 'Doctor',
      'booking.msgAddress': 'Address',
      'booking.msgLocation': 'Location'
    }
  };

  var ATTR_MAP = ['aria-label', 'alt', 'title', 'content', 'placeholder'];
  ...
  function applyLanguage(lang, persist) {
    ...
    document.dispatchEvent(new CustomEvent('nabd:langchange', { detail: { lang: lang } }));
  }
